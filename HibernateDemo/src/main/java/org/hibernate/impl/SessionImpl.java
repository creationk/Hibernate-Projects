  ...
  implements EventSource, org.hibernate.classic.Session, JDBCContext.Context
{
  ...
  public org.hibernate.Session getSession(EntityMode entityMode)
  {
    ...
    if (this.rootSession != null) {
      this.rootSession.getSession(entityMode);
    }
    errorIfClosed();
  ...
  public void managedFlush()
  {
    ...
    if (this.childSessionsByEntityMode != null)
    {
      ...
      while (iter.hasNext()) {
        ((org.hibernate.Session)iter.next()).flush();
      }
    }
  }
  ...
  public Object internalLoad(String entityName, Serializable id, boolean eager, boolean nullable)
    throws HibernateException
  {
    LoadEventListener.LoadType type = eager ? LoadEventListener.INTERNAL_LOAD_EAGER : nullable ? LoadEventListener.INTERNAL_LOAD_NULLABLE : LoadEventListener.INTERNAL_LOAD_LAZY;
  ...
  public Query createFilter(Object collection, String queryString)
  {
    errorIfClosed();
    checkTransactionSynchStatus();
    CollectionFilterImpl filter = new CollectionFilterImpl(queryString, collection, this, getFilterQueryPlan(collection, queryString, null, false).getParameterMetadata());
  ...
  public Object instantiate(String entityName, Serializable id)
    throws HibernateException
  {
    return instantiate(this.factory.getEntityPersister(entityName), id);
  }
  ...
  public EntityPersister getEntityPersister(String entityName, Object object)
  {
    errorIfClosed();
    if (entityName == null) {
      return this.factory.getEntityPersister(guessEntityName(object));
    }
    try
    {
      return this.factory.getEntityPersister(entityName).getSubclassEntityPersister(object, getFactory(), this.entityMode);
    }
    ...
    throws HibernateException
  {
    ...
    if (roleBeforeFlush == null)
    {
      ...
      plan = this.factory.getQueryPlanCache().getFilterQueryPlan(filter, roleAfterFlush.getRole(), shallow, getEnabledFilters());
    }
    else
    {
      plan = this.factory.getQueryPlanCache().getFilterQueryPlan(filter, roleBeforeFlush.getRole(), shallow, getEnabledFilters());
  ...
  public ScrollableResults scroll(CriteriaImpl criteria, ScrollMode scrollMode)
  {
    ...
    CriteriaLoader loader = new CriteriaLoader(getOuterJoinLoadable(entityName), this.factory, criteria, entityName, getEnabledFilters());
    ...
    throws HibernateException
  {
    ...
    {
      loaders[i] = new CriteriaLoader(getOuterJoinLoadable(implementors[i]), this.factory, criteria, implementors[i], getEnabledFilters());
  ...
  private void throwTransientObjectException(Object object)
    throws HibernateException
  {
    throw new TransientObjectException("object references an unsaved transient instance - save the transient instance before flushing: " + guessEntityName(object));
  }
    ...
    throws IOException, ClassNotFoundException
  {
    ...
    this.fetchProfile = ((String)ois.readObject());
    ...
    this.enabledFilters = ((Map)ois.readObject());
    this.childSessionsByEntityMode = ((Map)ois.readObject());
    
    Iterator iter = this.enabledFilters.values().iterator();
    while (iter.hasNext()) {
    ...
    throws IOException
  {
    ...
    oos.writeObject(this.fetchProfile);
    ...
    oos.writeObject(this.enabledFilters);
